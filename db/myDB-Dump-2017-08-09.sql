...
INSERT INTO `comments` VALUES (1,'Test comment','test',3,'2017-07-27 18:08:45'),(2,'Another comment.','test',3,'2017-08-04 23:04:45'),(3,'Още един коментар.','test',3,'2017-08-08 17:47:29'),(4,'Много готино място за почивка!','test',2,'2017-08-08 17:51:53'),(5,'Много хубаво местенце за отдих! Всичко е перфектно! :)','I.Ivanov',1,'2017-08-08 17:53:25'),(6,'Идеално място за почивка далеч от шумния град.','I.Ivanov',3,'2017-08-08 17:55:20');
...
INSERT INTO `orders` VALUES (1,'SPA релакс край Хисаря! Нощувка със закуска за трима, от Комплекс Старосел***, с. Старосел',135,'2017-08-08 17:32:36','I.Ivanov',3),(2,'Прохладно лято в Пампорово! 2, 3 или 5 нощувки на база All Inclusive, от Хотел Снежанка***',215,'2017-08-08 17:33:24','I.Ivanov',2),(3,'Почивка край Сливенски минерални бани. Две нощувки със закуски и вечери за двама, от Chateau Windy Hills**',95,'2017-08-08 17:33:58','test',1),(4,'SPA релакс край Хисаря! Нощувка със закуска за трима, от Комплекс Старосел***, с. Старосел',135,'2017-08-08 17:47:57','test',3);
...
-- Dump completed on 2017-08-09  2:12:25
