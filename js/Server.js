	...
	function(err, connection)
	{
		...
		else
		{
			...
			switch(operation)
			{
				...
				case "buyHoliday":
				{
					connection.query("INSERT INTO orders (Description, TotalPrice, DateOrdered, Nickname, HolidayID) VALUES (?, ?, NOW(), ?, ?)",
				...
				case "commentHoliday":
				{
					connection.query("INSERT INTO comments (Comment, Nickname, HolidayID, DateTime) VALUES (?, ?, ?, NOW())",
